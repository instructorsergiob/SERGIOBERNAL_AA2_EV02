...
public class servlets extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try(
             ...
             PreparedStatement st = con.prepareStatement("insert into aprendiz values(?,?,?)")
            ){
        ...
        out.println("<html><body><script>alert('Los datos se ingresaron correctamente'); location.href='index.jsp';</script></body></html>");
            ...
            PrintWriter  out = response.getWriter();
        out.println("<html><body><script>alert('Error al ingresar datos'); location.href='index.jsp';</script></body></html>");
        }
